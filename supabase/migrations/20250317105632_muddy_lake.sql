/*
  # Fix Chat Messages Constraints and Policies

  1. Changes
    - Drop existing problematic policies and constraints
    - Add proper message target validation
    - Create new uniquely named policies
    - Fix message read function
...
CREATE POLICY "messages_simple_insert_20250317"
ON chat_messages
FOR INSERT
TO authenticated
WITH CHECK (
...
CREATE POLICY "messages_simple_select_20250317"
ON chat_messages
FOR SELECT
TO authenticated
USING (
